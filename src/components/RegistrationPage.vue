...
async function registration() {
  ...
  axios.post("/api/public/uploadAvatar", formData).then((response) => {
    user.value.avatarUrl = response.data;
    axios
      .post("/api/public/registration", user.value)
      .then(() => {
  ...
  <div class="page">
    <div class="container">
      ...
      <form class="mb-3" @submit.prevent>
        ...
        <br />
        <button @click="registration" class="form-control btn btn-primary">
          Зарегистрироваться
        </button>
      </form>
